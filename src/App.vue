...
<template>
  <header class="container d-flex align-items-center">
    ...
    <div class="">
      <HelloWorld msg="Dota 2" />
    </div>
  </header>
  <div class="container text-center">
    <h1>เลือกฮีโร่ของคุณ</h1>
    <br />
    ไม่ว่าจะเป็นนักเวทจอมอุบายไปจนถึงอสูรดุร้ายและอันธพาลเจ้าเล่ห์ กลุ่มฮีโร่ของ
    Dota 2 นั้นมีขนาดใหญ่โตมโหฬารและหลากหลายไร้ขีดจำกัด
    ปลดปล่อยความสามารถน่าทึ่งและสกิลอัลติเมททำลายล้างเพื่อไปสู่ชัยชนะ
  </div>
  <div
    class="container border d-flex align-items-center"
    style="height: 50px; color: white"
  >
    <div class="col">กรองฮีโร่</div>
    <div class="col">
      สาย
      <button class="btn btn-light ms-1">str</button
      ><button class="btn btn-light ms-1">agi</button
      ><button class="btn btn-light ms-1">int</button>
    </div>
    <div class="col">
      ความยาก<button class="btn btn-light ms-1" type="radio" style="height: 30px;"></button
      ><button class="btn btn-light ms-1" type="radio" style="height: 30px;"></button
      ><button class="btn btn-light ms-1" type="radio" style="height: 30px;"></button>
    </div>
  </div>
  <RouterView />
